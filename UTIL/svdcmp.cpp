...
// Given a[1..m][1..n], compute the svd of a.
// Store U in a
// Store diagonal matrix of singular values in w[1..n]
// Store V in v[1..n][1..n], not V transpose!
...
// Solve A*X=B for X
// Given A decomposed using svdcmp into U W Vtranspose
